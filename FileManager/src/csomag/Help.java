...
public class Help extends JDialog {
	...
	public Help(int xk, int yk) {
		...
		textManFold.setFont(new Font("Tahoma", Font.PLAIN, 11));
		...
		textManFold.append("	- The new folder will always be created bellow the current folder, so\n	the appropriate parent folder should be selected\n");
		...
		textManFold.append("	- Only the current folder can be deleted, so the appropriate folder\n	must be selected\n");
		textManFold.append("	- Only empty folders can be deleted, if not empty, Error Message\n	will be displayed\n");
		textManFold.append("	- To delete, press Delete Cur. Folder button");
		textManFold.setCaretPosition(0);
		...
		textManFile.setFont(new Font("Tahoma", Font.PLAIN, 11));
		...
		textManFile.append("	- A new file can be created with content by typing the content into\n	the New File Content window\n");
		textManFile.append("	- New file can be created without content (blank), no need to specify\n	it's content\n");
		textManFile.append("	- Create: enter a name for teh new file and press the Create New\n	File button\n\n");
		textManFile.append("- Delete file\n");
		textManFile.append("	- A file can be deleted from the current folder, so the appropriate\n	folder must be selected\n");
		...
		textManFile.setCaretPosition(0);
